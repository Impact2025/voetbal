      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {problems.map((p) => (
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-neon/10 border border-neon/20 flex items-center justify-center mb-5">
                <p.icon size={18} className="text-neon-ink" />
              </div>
              <h3 className="font-bold text-lg mb-2 group-hover:text-neon-ink transition-colors">
                {p.title}
              </h3>
        ...
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-slate-700 text-lg leading-relaxed">
            <span className="text-slate-900 font-semibold">Skillkaart lost dit op.</span> Wij geloven dat professionele
            feedback niet alleen voor profclubs is weggelegd, maar voor{' '}
            <span className="text-neon-ink font-semibold">élk jeugdteam</span>. Met ons platform
            kost een evaluatie de coach minder dan{' '}
            <span className="text-slate-900 font-semibold">2 minuten</span>, en krijgt het kind een
